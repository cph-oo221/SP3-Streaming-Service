...
public class TextUI
{
    ...
    protected String getUserInput(String msg, ArrayList<IMedia> options)
    {
        displayMessage("*************************************************************");
    ...
    protected void mediaMenu(ArrayList<IMedia> options, User currentUser, boolean personalList)
    {
